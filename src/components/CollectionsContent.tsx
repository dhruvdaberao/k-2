      ...
      {sorted.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 md:py-20 text-center px-4 max-w-md mx-auto">
          <div className="mb-6 flex justify-center">
            {!qParam ? (
              <img src="/nav-icons/empty-collection.png" alt="Empty Collection" className="w-48 h-48 md:w-64 md:h-64 object-contain opacity-90" />
            ) : (
              <img src="/nav-icons/empty-search.png" alt="No Search Results" className="w-48 h-48 md:w-64 md:h-64 object-contain opacity-90" />
            )}
          </div>
