  ...
  return (
    <>
        ...
        <div className="nav-inner">
          ...
          <div className="nav-icons header-right">
            ...
            <Link
              ...
              title="Bag"
              style={{ alignItems: "center", marginLeft: "12px", position: "relative" }}
            >
              <div className="cart-wrapper-text">
                {isActive("/cart") ? (
                  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 24 24" fill="#5a3e2b" stroke="#5a3e2b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="cart-icon"><rect x="2" y="8" width="20" height="14" rx="2" ry="2" fill="#5a3e2b"/><path d="M7 8V6a5 5 0 0 1 10 0v2" fill="none"/></svg>
                ) : (
      ...
      <div className="mobile-bottom-nav">
        ...
        <Link href={authLink} prefetch={true} className={`bottom-nav-item profile-bottom ${isActive(authLink) ? "active" : ""}`} title={user ? "Profile" : "Login"}>
          {isActive(authLink) ? (
