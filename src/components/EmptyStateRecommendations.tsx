...
export default function EmptyStateRecommendations({ title }: { title: string }) {
  ...
  return (
    <div className="mt-12 w-full max-w-5xl mx-auto border-t border-[rgba(139,94,60,0.1)] pt-10 pb-10">
      <h3 className="text-2xl md:text-3xl font-bold font-serif text-[#2f2a26] mb-6 md:mb-8 text-center">{title}</h3>
