      ...
      <div className="product-page-grid">
        <div className="product-page-media product-image-container relative">
          {product.discount_badge && (
            <div className="absolute top-4 left-4 bg-[#C84C35] text-white pdp-badge-text z-10 shadow-md uppercase">
              {product.discount_badge}
            </div>
          )}
          <Gallery
        ...
        <div className="product-page-details">
          <div className="flex items-center gap-3 mb-4 lg:mt-3">
            <button 
              onClick={() => router.back()} 
              className="global-back-btn shrink-0"
              style={{ background: 'transparent', border: 'none', outline: 'none', color: '#5a3e2b', padding: '8px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
              title="Go Back"
            >
