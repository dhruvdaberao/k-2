      ...
      <div className="container pt-0 md:pt-5" style={{ paddingBottom: '30px' }}>
        ...
        <section className="home-section mt-16 md:mt-32 mb-8 md:mb-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-4 md:px-0">
            <Link 
              href="/about" 
              className="rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm hover:opacity-80 transition-opacity gap-3"
              style={{ backgroundColor: '#EAE1D3', border: '1px solid #C4A484' }}
            >
              <Info size={32} strokeWidth={1.5} style={{ color: '#4a3219' }} />
              <span className="font-serif font-bold text-xl" style={{ color: '#4a3219' }}>About Us</span>
            ...
            <Link 
              ...
              style={{ backgroundColor: '#EAE1D3', border: '1px solid #C4A484' }}
            >
              <MessageSquare size={32} strokeWidth={1.5} style={{ color: '#4a3219' }} />
              <span className="font-serif font-bold text-xl" style={{ color: '#4a3219' }}>Contact Us</span>
            ...
            <Link 
              ...
              style={{ backgroundColor: '#EAE1D3', border: '1px solid #C4A484' }}
            >
              <ShieldCheck size={32} strokeWidth={1.5} style={{ color: '#4a3219' }} />
              <span className="font-serif font-bold text-xl" style={{ color: '#4a3219' }}>Store Policies</span>
