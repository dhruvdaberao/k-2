    ...
    return (
        <main className="px-4 pt-28 pb-12 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ gap: '1.5rem' }}>
                <div className="checkout-card rounded-2xl shadow-sm p-6 flex flex-col" style={{ backgroundColor: '#F5EFE6', border: '1px solid #C4A484' }}>
            ...
            <div className="border-t border-stone-200" style={{ marginTop: '3.5rem', paddingTop: '2.5rem' }}>
                ...
                <div className="text-stone-600 space-y-4 text-base">
                    ...
                    <p><span className="font-semibold text-stone-800">Phone:</span> +91 7310045515</p>
                </div>
            </div>
        </main>
    );
