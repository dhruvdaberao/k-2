            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {formData.tags?.filter((tag: string) => !tag.startsWith('_homeSection:')).map((tag: string) => (
                  <div 
                    key={tag} 
                    className="px-3 py-1.5 bg-[#FDFBF7] text-[#4A3219] text-sm font-semibold rounded-lg border border-[#C4A484] shadow-sm"
                    style={{ display: 'inline-flex', flexDirection: 'row', alignItems: 'center', whiteSpace: 'nowrap', gap: '6px', width: 'fit-content' }}
                  >
                    ...
                    <button 
                      ...
                      style={{ background: 'transparent', border: 'none', padding: 0, margin: 0, outline: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                      title="Remove tag"
                    >
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(variant.tags || []).map((tag: string) => (
                            ...
                            >
                              ...
                              <button 
                                type="button" 
                                onClick={() => removeVariantTag(vIdx, tag)} 
                                className="text-[#ef4444] hover:text-red-700 transition-colors" 
                                style={{ background: 'transparent', border: 'none', padding: 0, margin: 0, outline: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }} 
                                title="Remove tag"
                              >
