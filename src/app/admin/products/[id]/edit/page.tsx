    ...
    <main className="min-h-screen bg-[#FDFBF7] py-20 px-4">
      <div className="max-w-4xl mx-auto" style={{ paddingTop: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
          <BackButton />
          <h1 className="text-3xl font-bold text-[#4A3219]" style={{ margin: 0 }}>Edit Product</h1>
        </div>
        <p className="text-[#8B7355]" style={{ marginBottom: '2rem', marginLeft: '48px' }}>Update details for {initialData.title}</p>
