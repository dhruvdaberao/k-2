                  ...
                  <div className="relative flex-shrink-0" style={{ width: '128px', height: '128px' }}>
                    ...
                    <div style={{ position: 'absolute', top: '-4px', right: '-4px', zIndex: 10 }}>
                      <button 
                        ...
                        style={{ width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#4A3219', color: 'white', borderRadius: '50%', border: 'none', cursor: 'pointer', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)', outline: 'none' }}
                      >
      ...
      {showDeleteModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', backgroundColor: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(4px)' }}>
          <div style={{ backgroundColor: '#FDFBF7', borderRadius: '16px', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)', width: '100%', maxWidth: '448px', border: '1px solid #C4A484', position: 'relative', zIndex: 10000, fontFamily: 'inherit', padding: '24px' }}>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: '#4A3219', marginBottom: '8px', margin: 0 }}>Delete Slide?</h3>
            <p style={{ color: '#8B7355', margin: 0, marginTop: '8px', marginBottom: '24px' }}>Are you sure you want to delete this carousel slide? This action cannot be undone.</p>
